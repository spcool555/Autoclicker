...
useEffect(()=>{
  ...
  const GetAllFeaturebox = ()=>{
      axios.get('http://localhost:8081/public/saverequirements/3').then((res)=>{
          setData(res.data)
  ...
  const Getallinstprocedures=()=>{
    axios.get('http://localhost:8081/public/instprocedure/3').then((res)=>{
      setData2(res.data)
  ...
  const GetAllApllicationData =()=>{
    axios.get('http://localhost:8081/public/Applicationbox/3').then((res)=>{
      setData3(res.data)
      console.log("data.instalprocedure..",res.data)
    }).catch((err)=>{
      console.log("err",err)
...
axios.get('http://localhost:8081/public/workflow/3').then((res)=>{
  setData4(res.data)
