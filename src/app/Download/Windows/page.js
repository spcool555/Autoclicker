...
<div className="p3 p4" >
    ...
    <div className="p0 p4 bg-[#F3F4F6]  p-5 md:px-10 md:py-8 border-slate-500 dark:border-black drop-shadow-[0_7px_29px_rgba(0,0,0,0.3)] rounded-sm">
          <div className="grid items-center text-center grid-cols-1 md:grid-cols-4 gap-3">
            <div className="text-center">
              <Image
                src="/windows.svg" width={50} height={50}
  ...
  data.map((item, ind) => (
    <div key={ind}> {/* Make sure to add a unique key for each element when using map */}
      <h3 className="font-semibold text-base text-gray-700 p4 dark:text-gray-300" dangerouslySetInnerHTML={{ __html: item.input1 }}></h3>
      <ul className="list-disc list-inside text-slate-600 p4 dark:text-slate-200 md:pl-5">
