...
<section class="bg-white dark:bg-gray-900 p0">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 p4 dark:text-white">AutoClicker</h2>
      <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400 p4">A full-fledged autoclicker with two modes of autoclicking</p>
    </div>
