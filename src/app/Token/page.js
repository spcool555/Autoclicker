...
<center>
<div class="m-10 max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <svg class="w-7 h-7 text-gray-500 dark:text-gray-400 mb-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
      ...
      {isToken ? (
        ...
        <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Your Generated Token</h5>
        
      ) : (
        // Render this if the user is not logged in
        <>
        <Link href="/SignIn">SignIn To Generate Yoken</Link>
        <br/>
        <br/>
        <br/>
        </>
    ...
    <div className="max-w-xs w-full inline-flex gap-x-2">
        ...
        <Link href="SignIn" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">SignIn</Link>
