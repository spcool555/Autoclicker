...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <h5 class="text-xl font-medium text-gray-900 dark:text-white">empty</h5>
        <hr/>
        <div className='py-5'>
          advertiment block
        </div>
...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Free version</h5>
        <hr/>
        <div className='py-5'>
        <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
            {
              data.map((item,ind)=>(
                ...
                <li class="flex items-center">
                    <svg class="w-3.5 h-3.5 me-2 text-yellow-500 dark:text-yellow-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        ...
        <h5 class="text-xl font-medium text-gray-900 dark:text-white">Paid version</h5>
        <hr/>
        <div className='py-5'>
        <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
            {
        ...
        <div className="max-w-screen-xl py-5">
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 px-4 leading-relaxed" dangerouslySetInnerHTML={{ __html: item.answers }}></p>
            </details>
                ))
              }
