...
useEffect(()=>{
  ...
  const GetAllFeaturebox = ()=>{
      axios.get('http://65.2.172.195:8081/public/saverequirements/3').then((res)=>{
          setData(res.data)
  ...
  const Getallinstprocedures=()=>{
    axios.get('http://65.2.172.195:8081/public/instprocedure/3').then((res)=>{
      setData2(res.data)
  ...
  const GetAllApllicationData =()=>{
    axios.get('http://65.2.172.195:8081/public/Applicationbox/3').then((res)=>{
      setData3(res.data)
      console.log("data.instalprocedure..",res.data)
    }).catch((err)=>{
      console.log("err",err)
...
axios.get('http://65.2.172.195:8081/public/workflow/3').then((res)=>{
  setData4(res.data)
    ...
    <div className="bg-[#F3F4F6] dark:bg-[#162458] p3 p-5 md:px-10 md:py-8 border-slate-500 dark:border-black drop-shadow-[0_7px_29px_rgba(0,0,0,0.3)] rounded-sm">
          <div className="grid items-center text-center grid-cols-1 md:grid-cols-4 gap-3">
            <div className="text-center">
              <Image
                src="/chrome.svg" width={50} height={50}
      ...
      <li dangerouslySetInnerHTML={{ __html: item.input2 }}></li> {/* Assuming item.input2 is a string, wrap it in a list item */}
        ...
        <ol className="relative border-s border-gray-300 dark:border-gray-700">
        {
          ...
          <li className="mb-10 ms-4">
            ...
            <div className="font-semibold text-gray-700 p4 dark:text-gray-300" dangerouslySetInnerHTML={{ __html: item.items }}>
