  ...
  <Row className="mb-8">
    <Col xl={3} lg={4} md={12} xs={12}>
      <div className="mb-4 mb-lg-0">
        <h4 className="mb-1 text-lg font-semibold">Applications of MT Auto Clicker</h4>
      </div>
    </Col>
    <Col xl={9} lg={8} md={12} xs={12}>
      <Card id="preferences" className="border border-gray-300 rounded-lg p-4">
        <Card.Body>
          <div className="mb-6">
            <h4 className="mb-1 text-lg font-semibold">Add Applications</h4>
          </div>
          ...
          <Row>
            <Col xs={12}>
              <Card>
                <Card.Body>
                  <Card.Title as="h4" className="mb-3 text-lg font-semibold">Featuresbox</Card.Title>
                  <div>
                    {data.map((item,ind)=>(
